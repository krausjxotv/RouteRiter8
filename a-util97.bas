...
Declare Function TerminateProcess _
        Lib "kernel32.dll" (ByVal ApphProcess As Long, _
...
Public Sub CheckWagPath(Wagname As String, _
                        Wagonpath As String, _
                        strWag As String, _
                        strPath As String)
    Dim i As Long
...
End Sub
Public Sub CheckNamePath(Engname As String, _
                         Engpath As String, _
                         strEng As String, _
                         strPath As String)
    Dim i As Long
...
Function FileExists(FullFilename As String) As Boolean
    ...
    Exit Function
MakeF:
    If Err.Number = 53 Then 'error, file not found
        FileExists = False
        Exit Function
...
'-----------------------------------------------------------
'
Function ResolveResString(ByVal resID As Integer, _
...
Function GetDiskSpaceFree(ByVal strDrive As String) As Long
    ...
    Else
        ...
        If Err.Number <> 0 Then    'If Setup Toolkit's DLL couldn't be found
            lDiskFree = -1
        End If
    End If
...
'-----------------------------------------------------------
'
Function MsgError(ByVal strmsg As String, _
                  ByVal intFlags As Integer, _
                  ByVal strCaption As String, _
                  Optional ByVal intLogType As Variant) As Integer
    Dim iRet As Integer
...
'-----------------------------------------------------------
'
Function MsgFunc(ByVal strmsg As String, _
                 ByVal intFlags As Integer, _
                 ByVal strCaption As String) As Integer
