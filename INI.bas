...
Public Function GetPrivateProfileSection(Section As String, _
                                         Default As String, _
...
Public Function GetPrivateProfileString(Section As String, _
                                        Key As String, _
                                        Default As String, _
                                        INIFile As String) As String
...
Public Sub GetPrivateProfileKeys(ByRef StrArr() As String, _
                                 Section As String, _
                                 INIFile As String)
    Dim i As Integer, CurPos As Long, CharPos As Integer
    ' Is it a valid section?
...
Public Sub WritePrivateProfileSection(Section As String, _
                                      value As String, _
                                      INIFile As String)
...
Public Sub WritePrivateProfileString(Section As String, _
                                     Key As String, _
                                     value As String, _
                                     INIFile As String)
...
Function ReplaceChars(Chars As String, _
                      Optional ReplaceChr As String, _
                      Optional ReplaceWith As String) As String
    Dim ChrCnt As Long
...
Sub ProtectStr(ByRef StrVal As String, _
               Optional Protect As Boolean = True, _
               Optional Section As Boolean)
...
Function FindLine(ByRef CurLine As Long, _
                  LineStr As String, _
                  Optional FindKey As Boolean) As Boolean
