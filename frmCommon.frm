...
Private Sub Command1_Click()
    ...
    Dim x        As Integer
    Dim NewFile  As Integer, NewFile2 As Integer, A$
...
GetAnother:
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An error occurred in subroutine 'Common Path' please advise" & vbCrLf & "Support with details of operation being processed.", vbExclamation, App.Title)
    'Resume Next
End Sub
