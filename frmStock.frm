...
Private Function ConvertAirBrakes(CompleteFilePath As String, _
                                  flagway As Integer) As Boolean
...
Private Function ConvertHandBrakes(CompleteFilePath As String, _
                                   flagway As Integer) As Boolean
    'CONVERTS A FILE FROM UNICODE TO TEXT OR VICE VERSA
    'RETURNS TRUE IF THE PROCESS IS SUCCESSFUL, OTHERWISE IT RETURNS FALSE
    'THE FILE MUST BE < (2^31 - 1) BYTES (2,147,483,647 BYTES)
...
Private Function ConvertBrakes(CompleteFilePath As String, _
                               flagway As Integer, _
                               strOld As String) As Boolean
    'CONVERTS A FILE FROM UNICODE TO TEXT OR VICE VERSA
    'RETURNS TRUE IF THE PROCESS IS SUCCESSFUL, OTHERWISE IT RETURNS FALSE
    'THE FILE MUST BE < (2^31 - 1) BYTES (2,147,483,647 BYTES)
...
Private Function ConvertFCoupling(CompleteFilePath As String, _
                                  flagway As Integer) As Boolean
    'CONVERTS A FILE FROM UNICODE TO TEXT OR VICE VERSA
    'RETURNS TRUE IF THE PROCESS IS SUCCESSFUL, OTHERWISE IT RETURNS FALSE
    'THE FILE MUST BE < (2^31 - 1) BYTES (2,147,483,647 BYTES)
...
Private Function ConvertFrontCoupling(CompleteFilePath As String, _
                                      flagway As Integer, _
                                      strOld As String) As Boolean
    'CONVERTS A FILE FROM UNICODE TO TEXT OR VICE VERSA
    'RETURNS TRUE IF THE PROCESS IS SUCCESSFUL, OTHERWISE IT RETURNS FALSE
...
Private Function ConvertCoupling(CompleteFilePath As String, _
                                 flagway As Integer, _
                                 strOld As String) As Boolean
    'CONVERTS A FILE FROM UNICODE TO TEXT OR VICE VERSA
    'RETURNS TRUE IF THE PROCESS IS SUCCESSFUL, OTHERWISE IT RETURNS FALSE
...
Private Sub GridStock_MouseDown(Button As Integer, _
                                Shift As Integer, _
                                x As Single, _
                                Y As Single)
