...
Public Sub CheckWagonData(strNew As String, _
                          Wagname As String, _
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An Error number " & Err.Number & " occurred in CheckwagonData checking " & strNew & vbCrLf & "Error description: " & Err.Description, vbExclamation, frmGrid)

End Sub

Public Sub CheckEngineData(strNew As String, _
                           Engname As String, _
                           Engpath As String, _
                           booFound As Boolean)
    Dim x As Integer, Y As Integer, yy As Integer, Z As Integer, strNew2 As String
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An Error number " & Err.Number & " occurred in CheckEngineData checking " & strNew & vbCrLf & "Error description: " & Err.Description, vbExclamation, frmGrid)
