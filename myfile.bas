...
Public Sub ExtractFileParts(strSourceFileName As String, _
                            strExtractedPath As String, _
                            strExtractedFile As String, _
                            strExtractedFileType As String)
...
Public Function ShellAndWait(PathName As String, _
                             blnDoEvents As Boolean, _
                             WS As VbAppWinStyle) As Double
