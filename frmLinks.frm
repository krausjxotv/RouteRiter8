...
Private Sub Command2_Click()
    ...
    GridLinks.col = 0
    Select Case MsgBox("Confirm you wish to delete all unlinked files from the Common Folders" & vbCrLf & "This operation can not be reversed.....", vbYesNo Or vbExclamation Or vbDefaultButton1, "WARNING...")
    Case vbYes
...
Private Sub Command3_Click()
    ...
    Select Case MsgBox("Confirm you wish to delete all selected files from the Common Folders" & vbCrLf & "This operation can not be reversed.....", vbYesNo Or vbExclamation Or vbDefaultButton1, "WARNING...")
