...
EndIt:
    ...
    Exit Sub
Errtrap:
    If Err.Number = 381 Then GoTo EndIt
End Sub
...
Errtrap:
    If Err.Number = 381 Then
        Resume Next
    Else
        Call MsgBox("An error #" & Err.Number & " occurred in subroutine 'CheckForConsistGrid' while checking" & vbCrLf & CFilepath, vbExclamation, frmConsists)
        Resume Next
    End If
End Sub
