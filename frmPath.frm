...
Private Sub Command1_Click()
    ...
    If Not FileExists(MSTSPath & "\train.exe") Then
        ...
        'booWrongMSTS = True
        'Exit Sub
        Select Case MsgBox("The selected folder does not contain 'Train.exe' so is not" & vbCrLf & "a main MSTS folder. Do you wish to continue", vbYesNo Or vbExclamation Or vbDefaultButton1, App.Title)
