...
Public Sub CreateNewKey(ByVal sNewKeyName As String, ByVal lPredefinedKey As Long)
...
Public Sub SetKeyValue(ByVal hHiveKey As Long, _
...
Function GetKeyValue(ByVal hHiveKey As Long, _
...
Public Function QueryValueEx(ByVal lhKey As Long, _
                             ...
                             ByRef vValue As Variant) As Long
...
Public Function DeleteKey(ByVal hStartKey As Long, ByVal sKeyName As String) As Long
...
Public Sub GetSubKeys(ByVal hHiveKey As Long, _
                      ByVal sKeyName As String, _
    ...
    lretval = RegOpenKeyEx(hHiveKey, sKeyName, 0, KEY_ENUMERATE_SUB_KEYS, hKey)
