...
Errtrap:
    If Err.Number = 75 Then
        Call MsgBox("One or more of the files you attempted to move/delete was a Read-Only file." & vbCrLf & "Select the route on the MSTS Route Utils screen and click Make Read/Write to fix.", vbExclamation, App.Title)
        Exit Sub
    End If
End Sub
