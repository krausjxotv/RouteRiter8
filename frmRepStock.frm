...
Private Sub GetCoupling(LocoPath As String, _
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An error " & Err.Number & " occurred in subroutine 'GetCoupling' please advise" & vbCrLf & "while checking " & LocoPath, vbExclamation, App.Title)
    'Resume Next
End Sub
...
Private Sub Command1_Click()
    ...
    Dim strGridPath      As String, strNewPath As String
    ...
    If flagGrid = 2 And Check1.value = 0 Then
        ...
        FileCopy MSTSPath & "\trains\consists\" & strCon, strTempFilesPath & "\" & strCon
        DoEvents
        ...
        Call ConvertStock(strTempFilesPath & "\" & strCon, flagway, strOldCon, strNewCon, strStockType)
        FileCopy strTempFilesPath & "\" & strCon, MSTSPath & "\trains\consists\" & strCon
        ...
        For i = 1 To frmStock.GridStock.Rows - 1
            ...
            If strExisting = strOldStock Then
                ...
                ElseIf Right(strCon, 3) = "act" Then
                    ...
                    FileCopy MSTSPath & "\Routes\" & strAct & "\Activities\" & strCon, strTempFilesPath & "\" & strCon
                    DoEvents
                    flagway = 0    'unicode to ascii
                    Call ConvertStock(strTempFilesPath & "\" & strCon, flagway, strOldCon, strNewCon, strStockType)
                    ...
                    flagway = 1    'unicode to ascii
                    Call ConvertStock(strTempFilesPath & "\" & strCon, flagway, strOldCon, strNewCon, strStockType)
                    FileCopy strTempFilesPath & "\" & strCon, MSTSPath & "\Routes\" & strAct & "\Activities\" & strCon
                    Kill strTempFilesPath & "\" & strCon
                    frmStock.GridStock.Select i, 3
                    frmStock.GridStock.Cell(flexcpText) = strTempCon & "." & strStockType
                End If
...
Errtrap:
    ...
    Call MsgBox("An error " & Err.Number & " occurred in subroutine 'LooseConsistGrid' please advise" & vbCrLf & "Support with details of operation being processed.", vbExclamation, App.Title)
    'Resume Next
