...
Private Sub Command1_Click()
    ...
    Exit Sub
Errtrap:
    Select Case MsgBox("An error " & Err.Number & " " & Err.Description & " occurred while Creating a Mini-Route please advise" & vbCrLf & "Support that x=" & Str(x), vbRetryCancel Or vbExclamation Or vbDefaultButton1, App.Title)
