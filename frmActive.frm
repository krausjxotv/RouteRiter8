    ...
    For i = 0 To List1.ListCount - 1
        If List1.Selected(i) = True Then
            If Right$(List1.List(i), 11) = "Train-Store" Then
                Call MsgBox(List1.List(i) & vbCrLf & "is stored in Train-Store, you must use Train-Store to activate it.", vbExclamation, App.Title)
            ...
            If frmUtils.File1(0).ListCount = 0 Then
                ...
                DoEvents
                If frmUtils.File1(0).ListCount = 0 Then
                    Call MsgBox("There is no '.trk' or '.off' file in this folder - Route may have been stored" & vbCrLf & "with Train-Store.", vbExclamation, App.Title)
                    GoTo CarryON
                Else
        ...
        ElseIf List1.Selected(i) = False Then
            ...
            If frmUtils.File1(0).ListCount = 0 Then
                ...
                DoEvents
                If frmUtils.File1(0).ListCount = 0 Then
                    Call MsgBox("There is no '.trk' or '.off' file in " & List1.List(i) & vbCrLf & "Route may have been stored with Train-Store.", vbExclamation, App.Title)
                    GoTo CarryON
                Else
