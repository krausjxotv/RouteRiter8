...
Private Sub GetWagPaths(strPix As String, _
                        strEP As String, _
                        strEN As String, _
                        sMass As Single)
...
Private Sub GetEngPaths(strPix As String, _
                        strEP As String, _
                        strEN As String, _
                        sMass As Single, _
                        sMax As Single, _
...
Private Sub GetWagDet(strWag As String, strFind As String, strTemp As String)
    ...
    strTemp = Trim(strTemp)
End Sub
Private Sub GetWagDetail(strEng As String, _
                         strCoupler As String, _
                         strWagType As String, _
                         strMass As String, _
                         strLen As String, _
                         strName As String)
...
Private Sub GetEngDetail(strEng As String, _
                         strCoupler As String, _
                         strPower As String, _
                         strMass As String, _
                         strLen As String, _
                         strName As String)
...
Public Sub CreateThumbnail(ByVal strShapePath, ByVal strAnimPath)
    ...
    If Dir$(strTempFilesPath & "\PIX*.jpg") = "" Then
        DoEvents
        Sleep 120
        sfCanvas1.saveImage
    End If
...
Private Sub mnuFlip_Click()
    ...
    Select Case MsgBox("Flip is not recommended (Unless you are using MSTSBin) as bogies on flipped" & vbCrLf & "stock may rotate in the wrong direction. Preferably use models" & vbCrLf & "built to run backwards. Only use this option to finalise your consist.", vbOKCancel Or vbExclamation Or vbDefaultButton1, App.Title)
    Case vbOK
...
Private Sub mnuOCF_Click()
    ...
    For i = 1 To numStock
        ...
        strStock = MSTSPath & "\Trains\Trainset\" & strCF & "\" & strCN & strTemp
        If Not FileExists(strStock) Then
            Call MsgBox(strCF & "\" & strCN & strTemp & " listed in this consist appears to be missing?" & vbCrLf & "Missing item was in position " & Str(i) & ". You can resave the " & vbCrLf & "consist without the missing items, or add replacements as required.", vbExclamation, App.Title)
            i = i - 1
            numStock = numStock - 1
