...
Private Sub LookForWag(strWag As String, strFoundPath As String)
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An Error number " & Err.Number & " occurred in LookForWag" & vbCrLf & "Error description: " & Err.Description, vbExclamation, frmGrid)
End Sub
...
Private Sub LookForLoco(strEng As String, strFoundPath As String)
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An Error number " & Err.Number & " occurred in LookForLoco" & vbCrLf & "Error description: " & Err.Description, vbExclamation, frmGrid)
End Sub
...
Private Sub SetLang()
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An Error number " & Err.Number & " occurred in SetLang" & vbCrLf & "Error description: " & Err.Description, vbExclamation, frmGrid)
End Sub
...
Errtrap:
    ...
    Call MsgBox("An error " & Err.Number & " occurred in subroutine 'frmGrid - Load' please advise" & vbCrLf & "Support with details of operation being processed.", vbExclamation, App.Title)
    Resume Next
    GoTo TryAnother
End Sub
...
Private Sub LooseActivities(ActPath As String)
    ...
    Exit Sub
Errtrap:
    Call MsgBox("An error " & Err.Number & " occurred in subroutine 'LooseActivities' please advise" & vbCrLf & "Support with details of operation being processed.", vbExclamation, App.Title)
    Resume Next
...
Errtrap:
    ...
    Call MsgBox("An Error number " & Err.Number & " occurred in LooseConsistsGrid" & vbCrLf & "Error description: " & Err.Description, vbExclamation, frmGrid)
...
Errtrap:
    ...
    Call MsgBox("An Error number " & Err.Number & " occurred in CheckForConsistCol" & vbCrLf & "Error description: " & Err.Description, vbExclamation, frmGrid)
...
Errtrap:
    ...
    Call MsgBox("An error #" & Err.Number & " occurred in subroutine 'CheckForConsistGrid' while checking" & vbCrLf & CFilepath, vbExclamation, frmGrid)
